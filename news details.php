  ...
  <div class="container">
    <div class="row all-text-white">
      <div class="col-md-12 align-self-center">
        <h1 class="fs-1 fw-bold  my-3">News Details</h1>
        ...
        <nav aria-label="breadcrumb" class="mt-3">
          <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item">News Deatils</li>
          </ol>
        </nav>
      </div>
    </div>
...
<section>
  <div class="container h-100">
    <div class="row">
      <div class="col-lg-7">
        <h4 class="h2 mb-5">School Toilet Project Completed In Dang</h4>
        <div>
      ...
      <div class="col-lg-5">
        <div class="card">
          <div class="card-body">
            <h4 class="h3 mb-4">Latest News</h4>
            <div>
              <div class="mb-4">
                <a href="" class="latest-news">
                  <h5 class="h5 mb-0 text-muted">School Toilet Project Completed In Dang</h5>
