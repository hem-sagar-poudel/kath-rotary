  ...
  <div class="container">
    <div class="row all-text-white">
      <div class="col-md-12 align-self-center">
        <h1 class="fs-1 fw-bold  my-3">Publication</h1>
...
<section>
  <div class="container h-100">
    <div class="row">
      <div class="col-lg-7">
        <h4 class="h3 mb-4 text-center">Publication</h4>
        <table class="table">
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <th> <a href="" class="text-link">Annual-Souvenir-2018-19.pdf</a></th>
              <td>2018-19 Souvenir</td>
              <td><button class="btn btn-md btn-danger">Dowbload</button></td>
            </tr>
            <tr>
              <th> <a href="" class="text-link">Annual-Souvenir-2018-19.pdf</a></th>
              <td>2018-19 Souvenir</td>
